...
resource "null_resource" "tf_env" {
  provisioner "local-exec" {
    ...
    echo_export "TF_VAR_ui_type" "none"
    # echo_export "OCI_STARTER_CREATION_DATE" "2025-11-26-19-16-39-101662"
    # echo_export "OCI_STARTER_VERSION" "4.2"
    # echo_export "OCI_STARTER_PARAMS" "prefix,java_framework,java_vm,java_version,ui_type,db_type,license_model,app_mode,mode,infra_as_code,db_password,oke_type,security,compartment_ocid,language,deploy_type"
    chmod 755 $ENV_FILE
    EOT
  }
  triggers = {
